...
import ProdukCrystaline from "../../../../components/ProdukCrystaline/shopData";
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            <div className="w-full">
              ...
              >
                {ProdukCrystaline.map((item, key) => //ganti PRODUKTEH sesuai component nya
                  productStyle === "grid" ? (
