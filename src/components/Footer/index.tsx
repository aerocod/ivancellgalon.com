        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                <a href="https://share.google/GOuAJD8b3Wy8fAva9" target="_blank" rel="noreferrer">Ruko Villa Bukit Mas, JL. H Abdul Wahab Siamin, Dukuh Kupang, Blok RM/5, Dukuh Pakis, Kec. Dukuhpakis, Surabaya, Jawa Timur 60225</a>
              </li>

              <li>
                <a href="https://wa.me/6281230000070" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <a href="https://wa.me/6281230000070">+62 812 3000 0070</a>
                </a>
              </li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="https://linktr.ee/ivancell_galon">
                  Linktree
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="https://id.shp.ee/wmehh3P">
                  Shopee
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="https://wa.me/6281230000070">
                  WhatsApp
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="https://www.instagram.com/ivancell_galon">
                  Instagram
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="https://tiktok.com/@ivancell_galon">
                  TikTok
                </a>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/AirMineral">
                  Air Mineral
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/Teh">
                  Teh
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/Isotonik">
                  Minuman Energi & Isotonik
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/Soda">
                  Minuman Bersoda
                </a>
              </li>
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/Jus">
                  Jus & Sirup
                </a>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="lg:text-right text-custom-sm mb-4">
              Menyediakan Air Mineral Sejak 2005
            </p>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. ivancellgalon.com All rights reserved by <a href="https://instagram.com/neilwebsite"> <u>@NeilWebsite</u></a>.
            </p>
